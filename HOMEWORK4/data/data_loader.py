...
def tokenize_and_pad(sentences, vocab):
    # Calculate the maximum sentence length for padding (+2 for <SOS> and <EOS>)
...
# Full dataset of English-French sentence pairs
english_to_french = [
...
# Iterate over the DataLoader and print batch details
